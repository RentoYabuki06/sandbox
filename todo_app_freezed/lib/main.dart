        ...
        children: [
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                ref.read(memoListProvider.notifier).state = [
                  ...
                  Memo(text: value, createdTime: DateTime.now()) // 新しい要素を追加
                ];
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ref.read(memoListProvider.notifier).state = [
                ...currentList,
                Memo(text: textController.text, createdTime: DateTime.now())
              ];
              ...
              trailing: Checkbox(
                ...
                onChanged: (bool? newValue) {
                  final updatedMemos = memos
                      .map((m) => m == memo
                          ? memo.copyWith(isCompleted: newValue ?? false)
                          : m)
                      .toList();
                  ref.read(memoListProvider.notifier).state = updatedMemos;
                  // SnackBarの表示
